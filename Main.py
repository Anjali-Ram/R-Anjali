...
geneticButton = Button(main, text="Genetic Algorithm", command=geneticAlgorithm)
geneticButton.place(x=50,y=150)
geneticButton.config(font=font1) 

batButton = Button(main, text="BAT Algorithm", command=runBat)
batButton.place(x=330,y=150)
batButton.config(font=font1) 

beeButton = Button(main, text="BEE Algorithm", command=runBee)
